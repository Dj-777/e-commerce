...
export class CartService {
                    ...
                    if (check_accesstoken) {
                        ...
                        if (product) {
                            ...
                            if (cart.length < 1) {
                                ...
                                return this.cartRepository.findOne({ total: product.Price * quantity });
                                ...
                                if (quantity === 0) {
                                    ...
                                    return this.cartRepository.findOne({ total });
                                }
                            }
                        }
                    }
    ...
    async getItemsInCart(req): Promise<CartEntity[]> {
                ...
                if (check_accesstoken) {
                    ...
                    if (check_accesstoken) {
                        ...
                        if (finduser) {
                            ...
                            const cart = await userCart.filter((item) => item.user?.id === check_accesstoken.id)
